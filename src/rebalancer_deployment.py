"""Shared helpers for deploying cash into underweight holdings.

These helpers are used by both the main sweep phase and the final
post-processing reconciliation pass so that buy-deployment rules live in one
place.
"""
